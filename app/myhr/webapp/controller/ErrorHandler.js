sap.ui.define([
	...
	return UI5Object.extend("com.sap.myhr.controller.ErrorHandler", {
		 ...
		 * @public
		 * @alias com.sap.myhr.controller.ErrorHandler
		 */
		constructor: function (oComponent) {
			...
			this._oResourceBundle.then(oBundle =>
				this._sErrorText = oBundle.getText('errorText')
			);
